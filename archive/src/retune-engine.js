...
export function createRetuner(opts) {
    ...
    function _remap(rawNotes, rawChords, rawAnchors, rawTemplates, tuning, capo, sc, target, maxFret, displayFretOffset) {
        ...
        // Physical-fret display shift: fretted output becomes r + capo.
        // Opens (fret 0) stay 0; slide targets always shift, even to 0,
        // since highway_3d positions them by literal fret, not as open.
